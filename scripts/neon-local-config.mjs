/**
 * Node preload for local Neon proxy (db.localtest.me + port 4444).
 * Usage: NODE_OPTIONS='--import ./scripts/neon-local-config.mjs' bun run dev
 */
