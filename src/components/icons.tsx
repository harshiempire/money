...
export function IconSpend({ className }: IconProps) {
  return (
    <svg className={cn("h-5 w-5", className)} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 0v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
    </svg>
  );
}
...
export function IconTransactions({ className }: IconProps) {
  return (
    <svg className={cn("h-5 w-5", className)} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75Zm.008 5.25h.007v.008H3.758v-.008Zm.008 5.25h.007v.008H3.766v-.008Z" />
    </svg>
  );
}
...
export function IconReimbursements({ className }: IconProps) {
  return (
    <svg className={cn("h-5 w-5", className)} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function IconLogo({ className }: IconProps) {
  return (
    <svg className={cn("h-8 w-8", className)} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="8" className="fill-[var(--color-accent)]" />
      <path d="M8 20.5C8 16.91 10.91 14 14.5 14H22" stroke="white" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M8 11.5C8 15.09 10.91 18 14.5 18H22" stroke="white" strokeWidth="2.5" strokeLinecap="round" opacity="0.6" />
    </svg>
  );
}
